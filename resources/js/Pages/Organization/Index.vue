                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6 text-gray-900">
                        <Modal :show="isModalOpen" @close="closeModal">
                            <div class="p-6">
                                <h2 class="text-gray-900">Are you sure you want to delete this organization?</h2>
                        ...
                        <div class="flex justify-between items-center mb-8">
                            <h1 class="font-semibold text-xl">Master Data: Organization</h1>
                            ...
                            <table class="table-fixed w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="py-4 border-b-2 w-full text-left">Name</th>
                                    ...
                                    <template v-if="props.organizations.data.length == 0">
                                        <tr>
                                            <td class="text-center py-4 text-gray-500" colspan="5">
                                                There is no organization data yet, add some
                                            </td>
                                        </tr>
                                    </template>
                                    <template v-else>
                                        <tr v-for="(organization, index) in props.organizations.data" :key="index" >
                                            ...
                                            <td class="py-4 border-b-2 text-center flex justify-center gap-x-4">
                                                ...
                                                <p @click="openDeleteModal(organization.id)" class="cursor-pointer text-blue-500 underline">Delete</p>
                                            </td>
                                        </tr>
                                    </template>
                                </tbody>
