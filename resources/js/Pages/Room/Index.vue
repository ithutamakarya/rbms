                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="flex justify-between items-center mb-8">
                            <h1 class="font-semibold text-xl">Master Data: Ruangan</h1>
                            ...
                            <table class="table-fixed w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="py-4 border-b-2 w-[160px]">Kapasitas</th>
                                        <th class="py-4 border-b-2 w-[160px]">Lantai</th>
                                    ...
                                    <template v-if="props.rooms.data.length == 0">
                                        <tr>
                                            <td class="text-center py-4 text-gray-500" colspan="5">
                                                Belum ada data ruangan sama sekali, tambahkan beberapa
                                            </td>
                                        </tr>
                                    </template>
                                    <template v-else>
